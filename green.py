...
# 3. സാധാരണ ഇന്ധന കണക്കുകൂട്ടൽ
base_fuel = (distance * 0.28) + (cargo_weight * 0.0004 * distance)

# 4. ക്വാണ്ടം ഒപ്റ്റിമൈസേഷൻ ലോജിക്
